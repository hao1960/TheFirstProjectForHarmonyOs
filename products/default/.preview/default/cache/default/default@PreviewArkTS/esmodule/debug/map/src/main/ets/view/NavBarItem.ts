...
export class NavBarItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("features/map/src/main/ets/view/NavBarItem.ets(14:5)", "map");
            Row.width('100%');
            Row.height(48);
            Row.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("features/map/src/main/ets/view/NavBarItem.ets(15:7)", "map");
            Text.margin({ right: 6 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("features/map/src/main/ets/view/NavBarItem.ets(23:7)", "map");
            Text.fontFamily('HarmonyHeiTi-Bold');
            Text.fontSize(16);
            Text.fontColor('#182431');
            Text.textAlign(TextAlign.Start);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("features/map/src/main/ets/view/NavBarItem.ets(30:7)", "map");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777239, "type": 20000, params: [], "bundleName": "com.huawei.quickstart", "moduleName": "default" });
            Image.debugLine("features/map/src/main/ets/view/NavBarItem.ets(31:7)", "map");
            Image.width(12);
            Image.height(24);
        }, Image);
        Row.pop();
